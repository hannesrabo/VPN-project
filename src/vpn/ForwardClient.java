...
public class ForwardClient
{
    ...
    private static void doHandshake() throws IOException {
        ...
        /* This is to where the vpn.ForwardClient should connect.
         * The vpn.ForwardServer creates a socket
         * dynamically and communicates the address (hostname and port number)
         * to vpn.ForwardClient during the handshake (ServerHost, ServerPort parameters).
