...
public class ForwardServer
{
    ...
    private void doHandshake() throws UnknownHostException, IOException, Exception {
        ...
        /* listenSocket is a new socket where the vpn.ForwardServer waits for the
         * client to connect. The vpn.ForwardServer creates this socket and communicates
         * the socket's address to the vpn.ForwardClient during the handshake, so that the
         * vpn.ForwardClient knows to where it should connect (ServerHost/ServerPort parameters).
        ...
        /* The final destination. The vpn.ForwardServer sets up port forwarding
